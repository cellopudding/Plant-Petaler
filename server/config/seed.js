...
db.once('open', async () => {
  ...
  const products = await Product.insertMany([
    ...
    },
    {
      ...
      image: 'https://perenual.com/storage/species_image/412_abelmoschus_manihot/og/14884640072_2e21234175_b.jpg',
      watering: 'Average',
      hardiness_zone: '8-10',
      sun: 'Full Sun',
      maintenance: 'Low',
    ...
    image: 'https://perenual.com/storage/species_image/52_acer_palmatum_crimson_prince/og/1-1274349109Jjby.jpg',
    watering: 'Frequent',
    hardiness_zone: '6',
    sun: 'Full Sun, Part Shade',
    maintenance: 'n/a',
    ...
    image: 'https://perenual.com/storage/species_image/2810_eryngium_yuccifolium/og/51507915961_da9407fd67_b.jpg',
    watering: 'Minimum',
    hardiness_zone: '3-8',
    sun: 'Full Sun',
    maintenance: 'Low',
    ...
    {
    name: 'Toad Lily',
    description: 'Toad lily flowers are often borne on upright, arching stems. Foliage varies with cultivar, as does the color of toad lily flowers, although most have the spotted appearance for which toad lilies are recognized. The toad lily plant grows taller in soils that are consistently moist.',
    image: 'https://perenual.com/storage/species_image/7936_tricyrtis_kohaku/og/6262198944_a0ea7a8ccc_b.jpg',
    watering: 'Frequent',
    hardiness_zone: '4-8',
    ...
    {
    name: 'Checkerbloom',
    description: 'Checker Bloom (Sidalcea malviflora) is a common native perennial herb in the Malvaceae (Mallow) family that grows in Northern, Southern and Central California, the Sierra Nevada and Sacramento Valley regions. It tends to grow in dry, open flats, at elevations from sea level to 7,500 feet. It has bright green palmate leaves and 1" deep pink flowers arranged vertically on a spike. There are several recognized subspecies with different geographic ranges and slightly differing characteristics.',
    image: 'https://perenual.com/storage/species_image/7361_sidalcea_elsie_heugh/og/50575944472_833cf76a56_b.jpg',
    watering: 'Average',
    hardiness_zone: '5-7',
    sun: 'Full Sun',
    maintenance: 'Moderate',
    ...
    image: 'https://perenual.com/storage/species_image/2489_digitalis_purpurea_excelsior_group/og/2560px-Digitalis_purpurea_Excelsior_Hybrids_3zz.jpg',
    watering: 'Average',
    hardiness_zone: '4-8',
    ...
    {
    name: 'Cranesbill',
    description: 'To the uninitiated, a "geranium" is that familiar annual plant so often found planted in cemetery urns, window boxes, and hanging baskets—a fleshy-leaved plant with long flower stalks and clustered blossoms. But, that plant, which often goes by the common name of "garden geranium" or "annual geranium," is actually a member of the Pelargonium genus of plants, and it has been since 1789, when the genus was separated from the Geranium genus.',
    image: 'https://perenual.com/storage/species_image/3155_geranium_oxonianum_bressinghams_delight/og/52284276512_7421e5f12c_b.jpg',
    watering: 'Average',
    hardiness_zone: '5-8',
    sun: 'Full Sun, Part Shade',
    maintenance: 'Moderate',
...

    {
      ...
      description:'This small, ornamental accent tree is quite uncommon and offers something for all seasons. In late spring, it produces drooping panicles of urn-shaped flowers, followed by similar seeds. In the fall, the tree provides a brilliant red color, along with a very distinctive habit. However, keep in mind that it requires very specific growing conditions.',
      image: 'https://perenual.com/storage/species_image/8480_abutilon_x_hybridum/og/11394506506_0a240e06a5_b.jpg',
      watering: 'Frequent',
      hardiness_zone: '10',
      sun: 'Full Sun, Part Shade',
      maintenance: 'n/a',
    ...
    {
      name: 'Urn Plant',
      description: 'The urn plant also has the common name of silver vase and is the most popular bromeliad from the Aechmea genus for growing and displaying indoors. The common names derive from the center of the plant being shaped like an urn or vase.',
      image: 'https://perenual.com/storage/species_image/549_aechmea_fasciata/og/51446529161_03b99a881f_b.jpg',
      watering: 'Average',
      ...
      },
    {
      ...
      image: 'https://perenual.com/storage/species_image/1215_begonia_rex-cultorum_super_curl/og/28152488224_06e2aca626_b.jpg',
      watering: 'Average',
      hardiness_zone: '10-11',
      sun: 'Full Sun, Part Shade',
      maintenance: 'Moderate',
    ...
    {
      name: 'Venus Fly Trap',
      description: 'The Venus flytrap is a flowering plant best known for its carnivorous eating habits. The “trap” is made of two hinged lobes at the end of each leaf. On the inner surfaces of the lobes are hair-like projections called trichomes that cause the lobes to snap shut when prey comes in contact with them.',
      image: 'https://perenual.com/storage/species_image/2500_dionaea_muscipula_cup-shaped/og/49820887063_7c309b02a2_b.jpg',
      watering: 'Frequent',
      hardiness_zone: '5-8',
      sun: 'Full Sun, Part Shade',
      maintenance: 'High',
    ...
    {
      name: 'Sago Palm',
      description: 'The sago palm may look like a tiny palm tree with its glossy, stiff fronds, but it is not a palm tree at all. Sago palms are cycads, some of the most ancient of plants that have been around since prehistoric times. They are easy to grow indoors as houseplants or outdoors in containers in warm areas. Dont let the mature height of these plants frighten you off. These slow-growers take many years to reach their final height.',
      image: 'https://perenual.com/storage/species_image/2272_cycas_revoluta/og/26712271676_6dc6c5fabc_b.jpg',
      watering: 'Average',
      hardiness_zone: '9-10',
      sun: 'Full Sun, Part Shade',
      maintenance: 'Low',
    ...
    {
      name: 'Earth Star',
      description: 'Earth Star is a native to Brazil boasting showy, bright pink leaves that form a star pattern. It is a bromelaid, which is a tropical plant having short stems with rosettes of stiff, spiny leaves.',
      image: 'https://perenual.com/storage/species_image/2244_cryptanthus_group/og/black-mystic-starfish-plant-crytanthus-earth-star.jpg',
      watering: 'Average',
    ...
    {
      name: 'Orchid',
      description: 'Orchids are popular houseplants that typically can be started anytime for indoor growth, though repotting is best after flowering. Orchid care for beginners is somewhat easy, as long as you understand the plants ideal conditions and maintenance requirements.',
      image: 'https://perenual.com/storage/species_image/2354_dendrobium_group/og/24982123521_e383f1921f_b.jpg',
      watering: 'Average',
      hardiness_zone: '9-12',
      sun: 'Part Shade',
      maintenance: 'High',
